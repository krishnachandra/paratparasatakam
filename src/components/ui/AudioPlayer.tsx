        ...
        <AnimatePresence>
            {currentTrack && (
                <motion.div
                    ...
                    className="fixed top-20 right-4 z-50 w-[85%] max-w-[280px] md:w-auto md:max-w-xs"
                >
                        ...
                        <div className="p-3 flex items-center justify-between gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-amber-500/20 to-purple-500/20 flex items-center justify-center border border-white/5">
                                        <div className={`w-1.5 h-1.5 rounded-full bg-amber-500 ${isPlaying ? 'animate-pulse' : ''}`} />
                                    </div>
                            ...
                            {/* Controls */}
                            <div className="flex items-center gap-3">
                                {/* Volume Control - Simplified for mobile/desktop unity */}
                                <div className="relative group flex items-center">
                                    ...
                                    <div className="w-0 overflow-hidden group-hover:w-16 transition-all duration-300 ease-out flex items-center">
                                        <input
                                            ...
                                            className="w-14 h-1 bg-white/20 rounded-lg appearance-none cursor-pointer accent-amber-500 ml-1"
                                        />
                                    </div>
                                </div>
                                ...
                                <button
                                    onClick={togglePlay}
                                    className="w-8 h-8 rounded-full bg-white text-black flex items-center justify-center hover:scale-105 active:scale-95 transition-all shadow-lg shadow-white/10"
                                >
                                    {isPlaying ? (
                                ...
                                <button
                                    onClick={closePlayer}
                                    className="text-white/40 hover:text-white/90 transition-colors p-1 hover:bg-white/10 rounded-full ml-1"
                                >
                                    <X size={14} />
                                </button>
                            </div>
